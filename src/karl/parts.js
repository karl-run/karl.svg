...
export const Head = ({ children }) => (
  <g>
    {/* høyre øre ytterst */}
    <ellipse cx="310.8" cy="222.3" class="cls-3" rx="15.9" ry="11.3" transform="rotate(-69 310.8 222.3)" />
    {/* høyre øre indre */}
    <ellipse cx="310.8" cy="222.3" class="cls-5" rx="9.2" ry="6.5" transform="rotate(-69 310.8 222.3)" />
    {/* venstre øre ytterst */}
    <ellipse cx="199.9" cy="222.3" class="cls-3" rx="11.3" ry="15.9" transform="rotate(-21 199.9 222.3)" />

    {/* venstre øre indre */}
    <ellipse cx="199.9" cy="222.3" class="cls-5" rx="6.5" ry="9.2" transform="rotate(-21 199.9 222.3)" />

    {/* head */}
    <rect width="34.1" height="42.5" x="237.3" y="271.3" class="cls-3" rx="12" ry="4" />
    <path
    ...
    <path
      ...
      class="cls-6"
    />
    <ellipse cx="290.8" cy="159.2" class="cls-20" rx="6.2" ry="12.4" transform="rotate(-60 290.8 159.2)" />
...
export const Shirt = () => (
  <g>
    ...
    <path d="M294.7 310.8l-11.6 2-29.4 18.2 20.5-24.3 5.1-5.9 15.4 10z" class="cls-11" />
    <path d="M214.8 310.8l11.6 2 29.4 18.2-20.5-24.3-5.4-5.7-15.1 9.8z" class="cls-11" />
    <path
...
export const Glasses = () => (
  <g>
    ...
    <path
      ...
      class="cls-10"
    />
    <path d="M213.2 210.9l14.1-9.1M220 211.1l14.1-9.2M268.6 210.9l14.1-9.1M275.4 211.1l14.1-9.2" class="cls-19" />
    <path
...
export const CoffeeCup = () => (
  <g>
    ...
    <path
      ...
      class="cls-16"
    />
    <path fill="#603813" d="M374.4 378.5a45.6 45.6 0 0 1-21.2 0c.4-1.5 5-2.7 10.7-2.7s10.2 1.2 10.5 2.7z" />
    <path
...
export const Arm = ({ right, x, y }) => {
  ...
  return (
    <g transform={`translate(${x} ${y})`}>
      <circle cx={213 + offset} cy="374.3" r="13.6" class="cls-3" />
      <rect
        width="21.1"
        height="5.4"
        x="191.5"
